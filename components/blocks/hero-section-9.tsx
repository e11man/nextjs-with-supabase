        ...
        <div>
            <header>
                <nav
                    ...
                    className="group fixed z-20 w-full border-b border-gray-200 bg-white backdrop-blur md:relative">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                            <div className="flex w-full justify-between lg:w-auto">
                                ...
                                <button
                                    ...
                                    className="relative z-20 -m-2.5 -mr-4 block cursor-pointer p-2.5 lg:hidden text-gray-900">
                                    ...
                                    <ul className="space-y-6 text-base lg:flex lg:gap-8 lg:space-y-0 lg:text-sm">
                                        {menuItems.map((item, index) => (
                                            <li key={index}>
                                                <Link
                                                    href={item.href}
                                                    className="text-gray-700 hover:text-gray-900 font-medium block duration-150">
                                                    <span>{item.name}</span>
                                                </Link>
                                            </li>
                                        ))}
            ...
            <main>
                ...
                <section className="bg-white relative z-10 py-16">
                    <div className="m-auto max-w-5xl px-6">
                        <h2 className="text-center text-lg font-semibold text-gray-800">Trusted by leading HR teams worldwide.</h2>
